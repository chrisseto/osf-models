# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-09-21 21:46
...
import osf_models.models.preprint
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guid_string', models.CharField(max_length=255)),
                ('content_type_pk', models.PositiveIntegerField()),
                ('type', models.CharField(choices=[('osf_models.node', 'node'), ('osf_models.collection', 'collection'), ('osf_models.registration', 'registration'), ('osf_models.preprint', 'preprint')], db_index=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', osf_models.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True, db_index=True, default=dict, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('_id', models.CharField(db_index=True, default=osf_models.models.base.generate_guid, max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('_id', models.CharField(db_index=True, default=osf_models.utils.base.generate_object_id, max_length=24, unique=True)),
                ('guid_string', models.CharField(blank=True, max_length=255, null=True)),
                ('content_type_pk', models.PositiveIntegerField(blank=True, null=True)),
                ('last_touched', models.DateTimeField(blank=True, null=True)),
                ('history', osf_models.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True, default=[])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type_pk', models.PositiveIntegerField(blank=True, null=True)),
                ('last_touched', models.DateTimeField(blank=True, null=True)),
                ('history', osf_models.utils.datetime_aware_jsonfield.DateTimeAwareJSONField(blank=True, default=list)),
                ('object_id', models.PositiveIntegerField(blank=True, null=True)),
                ('is_file', models.BooleanField(default=True)),
        ...
        migrations.AlterUniqueTogether(
            name='metaschema',
            unique_together=set([('name', 'schema_version', '_id')]),
        ),
        migrations.AddField(
