...
from addons.dropbox.tests.utils import DropboxAddonTestCase
from addons.dropbox.tests.utils import MockDropbox
from addons.dropbox.tests.utils import mock_responses
from addons.dropbox.tests.utils import patch_client
...
class TestAuthViews(DropboxAddonTestCase, views_testing.OAuthAddonAuthViewsTestCaseMixin, OsfTestCase):
    ...
    @mock.patch('addons.dropbox.models.DropboxProvider.auth_url', mock.PropertyMock(return_value='http://api.foo.com'))
