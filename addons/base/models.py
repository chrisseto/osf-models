...
class AddonSettingsBase(BaseModel):
...
class AddonUserSettingsBase(AddonSettingsBase):
    ...
    owner = models.OneToOneField(OSFUser)
    ...
    def nodes_authorized(self):
        ...
        if not model:
            return []
        return model.objects.find(user_settings=self, owner__is_deleted=False)
...
class AddonNodeSettingsBase(AddonSettingsBase):
    ...
    owner = models.OneToOneField(Node)
...
class AddonOAuthNodeSettingsBase(AddonNodeSettingsBase):
    ...
    def serialize_waterbutler_credentials(self):
        raise NotImplementedError("AddonOAuthNodeSettingsBase subclasses must implement a 'serialize_waterbutler_credentials' method.")

    def serialize_waterbutler_settings(self):
        raise NotImplementedError("AddonOAuthNodeSettingsBase subclasses must implement a 'serialize_waterbutler_settings' method.")
